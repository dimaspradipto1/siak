                ...
                <form action="{{ route('nilai.import') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="alert alert-info py-2 mb-0">
                            <small><i class="bi bi-info-circle me-1"></i> Pastikan NISN, Mata Pelajaran, Semester, dan Tahun Ajaran sesuai dengan data master.</small>
                        </div>
                    </div>
    ...
    <script>
        $(document).on('click', '.btn-hapus', function (e) {
            ...
            Swal.fire({
                ...
                html: `Anda yakin ingin menghapus data nilai ini?`,
                icon: 'warning',
