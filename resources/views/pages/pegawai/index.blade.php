                    ...
                    <div class="card-body pt-3">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <div class="d-flex gap-2">
                                <a href="{{ route('pegawai.template') }}" class="btn btn-secondary btn-sm" title="Download Template Import">
                                ...
                                <a href="{{ route('pegawai.export') }}" class="btn btn-info btn-sm text-white" title="Export Data">
...
@push('script')
    ...
    <script>
        ...
        $(document).on('click', '.btn-hapus', function (e) {
            ...
            Swal.fire({
                title: 'Hapus Pegawai?',
                html: `Anda yakin ingin menghapus data pegawai:<br><strong class="text-danger">${nama}</strong>?<br><small class="text-muted">Tindakan ini tidak dapat dibatalkan.</small>`,
                icon: 'warning',
