                ...
                <div class="card shadow-sm">
                    <div class="card-body pt-4">
                        ...
                        <div class="d-flex align-items-center gap-2 mb-4">
                            ...
                            <h5 class="mb-0 fw-bold text-primary">Form Tambah Profil Sekolah</h5>
                        </div>

                        <form action="{{ route('profil-sekolah.store') }}" method="POST" enctype="multipart/form-data" id="formCreate">
                            @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" id="nama_sekolah" name="nama_sekolah"
                                            ...
                                            value="{{ old('nama_sekolah') }}" required placeholder="Nama Sekolah">
                                        @error('nama_sekolah')
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" id="nis_nss_nds" name="nis_nss_nds"
                                            ...
                                            value="{{ old('nis_nss_nds') }}" placeholder="NIS/NSS/NDS">
                                        @error('nis_nss_nds')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" id="nama_kepala_sekolah" name="nama_kepala_sekolah"
                                            ...
                                            value="{{ old('nama_kepala_sekolah') }}" placeholder="Nama Kepala Sekolah">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" id="nip_kepala_sekolah" name="nip_kepala_sekolah"
                                            ...
                                            value="{{ old('nip_kepala_sekolah') }}" placeholder="NIP Kepala Sekolah">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" id="kelurahan_desa" name="kelurahan_desa"
                                            ...
                                            value="{{ old('kelurahan_desa') }}" placeholder="Kelurahan/Desa">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" id="kabupaten_kota" name="kabupaten_kota"
                                            ...
                                            value="{{ old('kabupaten_kota') }}" placeholder="Kabupaten/Kota">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" id="no_telephone" name="no_telephone"
                                            ...
                                            value="{{ old('no_telephone') }}" placeholder="No. Telephone">
                                        @error('no_telephone')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label for="logo_sekolah" class="form-label fw-semibold">Upload Logo Sekolah</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea id="deskripsi" name="deskripsi" rows="3"
                                            ...
                                            placeholder="Visi, Misi, atau deskripsi singkat sekolah">{{ old('deskripsi') }}</textarea>
                                        @error('deskripsi')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
