...
@section('title', 'Tambah Data Mata Pelajaran Aktif')

@section('content')
    <div class="pagetitle">
        <h1>Tambah Data Mata Pelajaran Aktif</h1>
        <nav class="mb-4">
            <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
                <div class="card border-0 shadow-sm rounded-3">
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('matapelajaranaktif.store') }}" method="POST" id="formTambahMapelAktif">
                            @csrf
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select id="master_mapel_id" name="master_mapel_id" 
                                        ...
                                        @foreach($masterMapels as $mp)
                                            <option value="{{ $mp->id ?? $mp->kode_mapel }}" {{ old('master_mapel_id') == ($mp->id ?? $mp->kode_mapel) ? 'selected' : '' }}>
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="hari_mengajar" name="hari_mengajar" 
                                        ...
                                        value="{{ old('hari_mengajar') }}" required placeholder="Contoh: Senin">
