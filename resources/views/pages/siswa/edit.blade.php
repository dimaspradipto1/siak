...
@section('content')
    <div class="pagetitle mb-4">
        <h1 class="fw-bold text-dark fs-4">Form Edit Data Siswa</h1>
    </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('siswa.update', $siswa->id) }}" method="POST" id="formEditSiswa">
                            ...
                            <div class="row g-3 mb-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="nisn" name="nisn" 
                                        ...
                                        value="{{ old('nisn', $siswa->nisn) }}" required placeholder="Masukkan NISN">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="nama_siswa" name="nama_siswa" 
                                        ...
                                        value="{{ old('nama_siswa', $siswa->nama_siswa) }}" required placeholder="Masukkan Nama Lengkap">
                            ...
                            <div class="row g-3 mb-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="tempat_lahir" name="tempat_lahir" 
                                        ...
                                        value="{{ old('tempat_lahir', $siswa->tempat_lahir) }}" required placeholder="Kota Lahir">
                            ...
                            <div class="row g-3 mb-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="nomor_wa" name="nomor_wa" 
                                        ...
                                        value="{{ old('nomor_wa', $siswa->nomor_wa) }}" placeholder="Nomor WA Siswa">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="email" id="email_siswa" name="email_siswa" 
                                        ...
                                        value="{{ old('email_siswa', $siswa->user->email ?? '') }}" placeholder="Email Siswa">
                            ...
                            <div class="row g-3 mb-4">
                                ...
                                {{-- Password --}}
                                <div class="col-md-3">
                                    <label for="password_siswa" class="form-label fw-medium text-secondary">Password Baru (Opsional)</label>
                            ...
                            <div class="row g-3 mb-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="nama_ayah" name="nama_ayah" 
                                        ...
                                        value="{{ old('nama_ayah', $siswa->orangTua->nama_ayah ?? '') }}" placeholder="Nama Ayah">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="pekerjaan_ayah" name="pekerjaan_ayah" 
                                        ...
                                        value="{{ old('pekerjaan_ayah', $siswa->orangTua->pekerjaan_ayah ?? '') }}" placeholder="Pekerjaan Ayah">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="nomor_wa_ayah" name="nomor_wa_ayah" 
                                        ...
                                        value="{{ old('nomor_wa_ayah', $siswa->orangTua->nomor_wa ?? '') }}" placeholder="No. WA Ayah">
                            ...
                            <div class="row g-3 mb-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="nama_ibu" name="nama_ibu" 
                                        ...
                                        value="{{ old('nama_ibu', $siswa->orangTua->nama_ibu ?? '') }}" placeholder="Nama Ibu">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="pekerjaan_ibu" name="pekerjaan_ibu" 
                                        ...
                                        value="{{ old('pekerjaan_ibu', $siswa->orangTua->pekerjaan_ibu ?? '') }}" placeholder="Pekerjaan Ibu">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="nomor_wa_ibu" name="nomor_wa_ibu" 
                                        ...
                                        value="{{ old('nomor_wa_ibu', $siswa->orangTua->nomor_wa_ibu ?? '') }}" placeholder="No. WA Ibu">
                            ...
                            <div class="row g-3 mb-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <textarea id="alamat_ortu" name="alamat_ortu" rows="2" 
                                        ...
                                        placeholder="Alamat Orang Tua">{{ old('alamat_ortu', $siswa->orangTua->alamat ?? '') }}</textarea>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="email" id="email_ortu" name="email_ortu" 
                                        ...
                                        value="{{ old('email_ortu', $siswa->orangTua->email ?? ($siswa->orangTua->user->email ?? '')) }}" placeholder="Email Orang Tua">
                                    @error('email_ortu')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>

                                {{-- Password Baru --}}
                                <div class="col-md-4">
                                    <label for="password_ortu" class="form-label fw-medium text-secondary">Password Baru (Opsional)</label>
                                    <div class="input-group">
