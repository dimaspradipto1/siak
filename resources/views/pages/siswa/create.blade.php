                        ...
                        <form action="{{ route('siswa.store') }}" method="POST">
                                ...
                                <div class="col-md-6 mt-3 mt-md-0">
                                    ...
                                    <select id="orang_tua_id" name="orang_tua_id" class="form-select @error('orang_tua_id') is-invalid @enderror">
                                        ...
                                        @foreach($orangTuas as $ot)
                                            <option value="{{ $ot->id }}" {{ old('orang_tua_id') == $ot->id ? 'selected' : '' }}>{{ $ot->nama_ayah ?? $ot->nama_ibu ?? 'Wali' }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    ...
                                    <select id="ekstrakurikuler_id" name="ekstrakurikuler_id" class="form-select @error('ekstrakurikuler_id') is-invalid @enderror">
                                        ...
                                        @foreach($ekstrakurikulers as $ekskul)
                                            <option value="{{ $ekskul->id }}" {{ old('ekstrakurikuler_id') == $ekskul->id ? 'selected' : '' }}>{{ $ekskul->nama_ekskul }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6 mt-3 mt-md-0">
                                    ...
                                    <input type="date" id="tgl_masuk" name="tgl_masuk" class="form-control @error('tgl_masuk') is-invalid @enderror" value="{{ old('tgl_masuk', date('Y-m-d')) }}">
                            ...
                            <div class="d-flex justify-content-between align-items-center border-top pt-3">
                                ...
                                <button type="submit" class="btn btn-primary"><i class="bi bi-save me-1"></i> Simpan Data Siswa</button>
                            </div>
                        </form>
                    </div>
                </div>
