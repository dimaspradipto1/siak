            ...
            <div class="col-lg-8">
                <div class="card shadow-sm">
                    <div class="card-body pt-4">
                        ...
                        <form action="{{ route('guru.update', $guru->id) }}" method="POST" id="formEdit">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="input-group">
                                    ...
                                    <select id="pegawai_id" name="pegawai_id"
                                        ...
                                        @foreach($pegawais as $pegawai)
                                            <option value="{{ $pegawai->id }}" data-nip="{{ $pegawai->nip }}" {{ old('pegawai_id', $guru->pegawai_id) == $pegawai->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="nip_guru" name="nip_guru"
                                            ...
                                            value="{{ old('nip_guru', $guru->nip_guru) }}"
