...
@section('title', 'Tambah Mata Pelajaran Aktif')

@section('content')
    <div class="pagetitle mb-4">
        <h1 class="fw-bold text-dark fs-4">Form Tambah Mata Pelajaran Aktif</h1>
    </div>
            ...
            <div class="col-lg-10">
                <div class="card border-0 shadow-sm rounded-3">
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('matapelajaran.store') }}" method="POST" id="formTambahMapelAktif">
                            @csrf
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="nama_mata_pelajaran" name="nama_mata_pelajaran" 
                                        ...
                                        value="{{ old('nama_mata_pelajaran') }}" required placeholder="Masukkan Nama Mapel">
                            ...
                            <div class="row g-3 mb-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="jam_mengajar" name="jam_mengajar" 
                                        ...
                                        value="{{ old('jam_mengajar') }}" required placeholder="Contoh: 07:30 - 09:00">
