...
@section('title', 'Edit Mata Pelajaran Aktif')

@section('content')
    <div class="pagetitle mb-4">
        <h1 class="fw-bold text-dark fs-4">Form Edit Mata Pelajaran Aktif</h1>
    </div>
            ...
            <div class="col-lg-10">
                <div class="card border-0 shadow-sm rounded-3">
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('matapelajaran.update', $matapelajaran->id) }}" method="POST" id="formEditMapelAktif">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="nama_mata_pelajaran" name="nama_mata_pelajaran" 
                                        ...
                                        value="{{ old('nama_mata_pelajaran', $matapelajaran->nama_mata_pelajaran) }}" required placeholder="Masukkan Nama Mapel">
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-md-4">
                                    ...
                                    <select id="hari_mengajar" name="hari_mengajar" 
                                        class="form-select rounded-3 @error('hari_mengajar') is-invalid @enderror" required>
                            ...
                            <div class="d-flex justify-content-end align-items-center gap-2 pt-3 border-top">
                                <a href="{{ route('matapelajaran.jadwal') }}" class="btn btn-outline-secondary px-4 py-2 rounded-3">
                                    Batal
                                </a>
