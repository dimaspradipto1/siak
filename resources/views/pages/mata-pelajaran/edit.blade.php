                        ...
                        <form action="{{ route('matapelajaran.update', $matapelajaran->id) }}" method="POST" id="formEditMapel">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="tp_optimal" name="tp_optimal" 
                                    ...
                                    value="{{ old('tp_optimal', $matapelajaran->tp_optimal) }}" placeholder="Masukkan TP yang Diukur & Tercapai Optimal">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" id="tp_peningkatan" name="tp_peningkatan" 
                                    ...
                                    value="{{ old('tp_peningkatan', $matapelajaran->tp_peningkatan) }}" placeholder="Masukkan TP yang Diukur & Perlu Peningkatan">
