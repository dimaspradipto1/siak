                        ...
                        <form action="{{ route('matapelajaran.update', $matapelajaran->id) }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" id="kode_mapel" name="kode_mapel" class="form-control @error('kode_mapel') is-invalid @enderror" value="{{ old('kode_mapel', $matapelajaran->kode_mapel) }}" placeholder="Contoh: MP001">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" id="nama_mata_pelajaran" name="nama_mata_pelajaran" class="form-control @error('nama_mata_pelajaran') is-invalid @enderror" value="{{ old('nama_mata_pelajaran', $matapelajaran->nama_mata_pelajaran) }}" placeholder="Contoh: Matematika">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" id="kkm" name="kkm" class="form-control @error('kkm') is-invalid @enderror" value="{{ old('kkm', $matapelajaran->kkm) }}" min="0" max="100">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select id="guru_id" name="guru_id" class="form-select @error('guru_id') is-invalid @enderror">
                                        ...
                                        @foreach($gurus as $g)
                                            <option value="{{ $g->id }}" {{ old('guru_id', $matapelajaran->guru_id) == $g->id ? 'selected' : '' }}>{{ $g->pegawai?->nama_pegawai ?? '-' }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select id="kelas_id" name="kelas_id" class="form-select @error('kelas_id') is-invalid @enderror">
                                        ...
                                        @foreach($kelas as $k)
                                            <option value="{{ $k->id }}" {{ old('kelas_id', $matapelajaran->kelas_id) == $k->id ? 'selected' : '' }}>{{ $k->nama_kelas }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select id="tahun_ajaran_id" name="tahun_ajaran_id" class="form-select @error('tahun_ajaran_id') is-invalid @enderror">
                                        ...
                                        @foreach($tahunAjarans as $ta)
                                            <option value="{{ $ta->id }}" {{ old('tahun_ajaran_id', $matapelajaran->tahun_ajaran_id) == $ta->id ? 'selected' : '' }}>{{ $ta->nama_tahun_ajaran }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select id="semester_id" name="semester_id" class="form-select @error('semester_id') is-invalid @enderror">
                                        ...
                                        @foreach($semesters as $s)
                                            <option value="{{ $s->id }}" {{ old('semester_id', $matapelajaran->semester_id) == $s->id ? 'selected' : '' }}>{{ $s->nama_semester }} - {{ $s->tahunAjaran?->nama_tahun_ajaran }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select id="hari_mengajar" name="hari_mengajar" class="form-select @error('hari_mengajar') is-invalid @enderror">
                                        ...
                                        @foreach(['Senin', 'Selasa', 'Rabu', 'Kamis', 'Jumat', 'Sabtu'] as $hari)
                                            <option value="{{ $hari }}" {{ old('hari_mengajar', $matapelajaran->hari_mengajar) == $hari ? 'selected' : '' }}>{{ $hari }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="jam_mengajar" name="jam_mengajar" class="form-control @error('jam_mengajar') is-invalid @enderror" value="{{ old('jam_mengajar', $matapelajaran->jam_mengajar) }}" placeholder="Contoh: 07:30 - 09:00">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="tp_optimal" name="tp_optimal" class="form-control @error('tp_optimal') is-invalid @enderror" rows="3" placeholder="Masukkan Tujuan Pembelajaran yang sudah dicapai dengan optimal oleh siswa">{{ old('tp_optimal', $matapelajaran->tp_optimal) }}</textarea>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea id="tp_peningkatan" name="tp_peningkatan" class="form-control @error('tp_peningkatan') is-invalid @enderror" rows="3" placeholder="Masukkan Tujuan Pembelajaran yang memerlukan bimbingan/peningkatan bagi siswa">{{ old('tp_peningkatan', $matapelajaran->tp_peningkatan) }}</textarea>
