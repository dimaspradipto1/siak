                        ...
                        <form action="{{ route('orang-tua.update', $orangTua->id) }}" method="POST">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="nama_ayah" name="nama_ayah" class="form-control @error('nama_ayah') is-invalid @enderror" value="{{ old('nama_ayah', $orangTua->nama_ayah) }}">
                                ...
                                <div class="col-md-6 mt-3 mt-md-0">
                                    ...
                                    <input type="text" id="nama_ibu" name="nama_ibu" class="form-control @error('nama_ibu') is-invalid @enderror" value="{{ old('nama_ibu', $orangTua->nama_ibu) }}">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="pekerjaan_ayah" name="pekerjaan_ayah" class="form-control @error('pekerjaan_ayah') is-invalid @enderror" value="{{ old('pekerjaan_ayah', $orangTua->pekerjaan_ayah) }}">
                                ...
                                <div class="col-md-6 mt-3 mt-md-0">
                                    ...
                                    <input type="text" id="pekerjaan_ibu" name="pekerjaan_ibu" class="form-control @error('pekerjaan_ibu') is-invalid @enderror" value="{{ old('pekerjaan_ibu', $orangTua->pekerjaan_ibu) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="nomor_wa" name="nomor_wa" class="form-control @error('nomor_wa') is-invalid @enderror" value="{{ old('nomor_wa', $orangTua->nomor_wa) }}">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea id="alamat" name="alamat" rows="3" class="form-control @error('alamat') is-invalid @enderror">{{ old('alamat', $orangTua->alamat) }}</textarea>
