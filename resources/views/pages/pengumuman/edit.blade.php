                    ...
                    <div class="card-body pt-4">
                        ...
                        <form action="{{ route('pengumuman.update', $pengumuman->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="judul" name="judul" class="form-control @error('judul') is-invalid @enderror" value="{{ old('judul', $pengumuman->judul) }}">
                                @error('judul')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>

                            <div class="mb-4">
                                <label for="keterangan" class="form-label fw-semibold">Isi Pengumuman <span class="text-danger">*</span></label>
                                <textarea id="keterangan" name="keterangan" rows="6" class="form-control @error('keterangan') is-invalid @enderror">{{ old('keterangan', $pengumuman->keterangan) }}</textarea>
