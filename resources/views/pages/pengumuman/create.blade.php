...
@section('content')
    <div class="pagetitle">
        <h1 class="text-primary fw-bold">Tambah Pengumuman</h1>
        <nav>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
                <div class="card shadow-sm border-0" style="border-radius: 12px;">
                    <div class="card-body pt-4">
                        <h5 class="card-title text-dark fw-bold mb-4 p-0">Form Tambah Data Pengumuman</h5>

                        <form action="{{ route('pengumuman.store') }}" method="POST" class="row g-4">
                            @csrf
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" id="judul" name="judul" class="form-control py-2 @error('judul') is-invalid @enderror" value="{{ old('judul') }}" placeholder="Masukkan judul pengumuman" style="border-radius: 8px;">
                                @error('judul')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>

                            <div class="col-12">
                                <label for="keterangan" class="form-label fw-semibold text-dark">Isi Pengumuman <span class="text-danger">*</span></label>
                                <textarea id="keterangan" name="keterangan" rows="8" class="form-control @error('keterangan') is-invalid @enderror" placeholder="Tulis isi pengumuman secara detail..." style="border-radius: 8px;">{{ old('keterangan') }}</textarea>
