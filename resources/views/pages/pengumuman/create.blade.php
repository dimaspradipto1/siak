                    ...
                    <div class="card shadow-sm border-0 pb-3">
                        <div class="card-body pt-4">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="judul" name="judul" class="form-control @error('judul') is-invalid @enderror" value="{{ old('judul') }}" placeholder="Masukkan judul pengumuman">
                                @error('judul')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>

                            <div class="mb-0">
                                <label for="keterangan" class="form-label fw-semibold">Isi Pengumuman <span class="text-danger">*</span></label>
                                <textarea id="keterangan" name="keterangan" rows="8" class="form-control @error('keterangan') is-invalid @enderror" placeholder="Tulis isi pengumuman secara detail...">{{ old('keterangan') }}</textarea>
