    ...
    <script>
        ...
        $(document).on('click', '.btn-hapus', function (e) {
            ...
            Swal.fire({
                ...
                html: `Anda yakin ingin menghapus tahun ajaran:<br><strong class="text-danger">${nama}</strong>?<br><small class="text-muted">Tindakan ini tidak dapat dibatalkan.</small>`,
                icon: 'warning',
