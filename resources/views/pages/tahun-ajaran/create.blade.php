                ...
                <div class="card shadow-sm">
                    <div class="card-body pt-4">
                        ...
                        <div class="d-flex align-items-center gap-2 mb-4">
                            ...
                            <h5 class="mb-0">Form Tambah Tahun Ajaran Baru</h5>
                        </div>

                        <form action="{{ route('tahun-ajaran.store') }}" method="POST" id="formCreate">
                            @csrf
...
@push('script')
    <script>
        ...
        // Trigger auto-fill on page load jika ada old value
        @if(old('tahun_mulai'))
            document.getElementById('tahun_mulai').dispatchEvent(new Event('input'));
        @endif
