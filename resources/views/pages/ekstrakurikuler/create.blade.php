                    ...
                    <div class="card-body pt-4">
                        ...
                        <form action="{{ route('ekstrakurikuler.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="nama_ekskul" name="nama_ekskul" class="form-control @error('nama_ekskul') is-invalid @enderror" value="{{ old('nama_ekskul') }}" placeholder="Contoh: Pramuka, PMR, Futsal">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="pembina" name="pembina" class="form-control @error('pembina') is-invalid @enderror" value="{{ old('pembina') }}" placeholder="Contoh: Budi Santoso, S.Pd">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea id="keterangan" name="keterangan" rows="3" class="form-control @error('keterangan') is-invalid @enderror" placeholder="Contoh: Setiap hari Sabtu jam 14.00">{{ old('keterangan') }}</textarea>
